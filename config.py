...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7748442271:AAFTysKgZR44gGjZYw7ks9giongKFQlFnd8")
#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "26513107"))
#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "f14ce4b58dc8812cfc9665588472f2d4")
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002336470887"))
# NAMA OWNER
...
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Dawnload94:Dawnload94@cluster0.ursfl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1002483951948"))
#put 0 to disable
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002377421372"))#put 0 to disable
...
try:
    ADMINS=[6376328008]
    for x in (os.environ.get("ADMINS", "1928404158").split()):
        ADMINS.append(int(x))
except ValueError:
